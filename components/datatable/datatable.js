...
import { NgModule, Component, ElementRef, Input, ViewContainerRef, ViewChild, Output, EventEmitter, ContentChild, ContentChildren, Renderer, IterableDiffers, QueryList, TemplateRef, ChangeDetectorRef, Inject, forwardRef } from '@angular/core';
...
ScrollableView = __decorate([
    ...
    __param(0, Inject(forwardRef(function () { return DataTable; }))),
    __metadata("design:paramtypes", [DataTable, DomHandler, ElementRef, Renderer])
], ScrollableView);
...
DataTable = __decorate([
    ...
    __metadata("design:paramtypes", [ElementRef, DomHandler, IterableDiffers,
        Renderer, ChangeDetectorRef, ObjectUtils])
], DataTable);
export { DataTable };
